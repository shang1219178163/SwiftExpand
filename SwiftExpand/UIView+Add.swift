...
extension UIView {
    ...
    /// [源]UILabel创建
    @objc public static func createLabel(_ rect: CGRect = .zero, text: String? = nil, font: CGFloat, tag: Int, type: Int = 0) -> UILabel {
    ...
    @objc public static func createSectionView(_ tableView: UITableView, text: String?, textAlignment: NSTextAlignment = .left, height: CGFloat) -> UIView{
    ...
    /// [源]GroupView创建
    @objc public static func createGroupView(_ rect: CGRect = .zero, list:Array<String>!, numberOfRow:Int, padding:CGFloat = kPadding, type: Int = 0, action:@escaping (UITapGestureRecognizer?, UIView, NSInteger)->()) -> UIView {
    ...
    /// [源]UISwitch创建
    @objc public static func createSwitch(_ rect: CGRect = .zero, isOn: Bool = false) -> UISwitch {
