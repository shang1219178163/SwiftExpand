...
//        static var normalDic    = "UIButton" + "normalDic"
//        static var heightDic    = "UIButton" + "heightDic"
//        static var selectedDic  = "UIButton" + "selectedDic"
//        static var disabledDic  = "UIButton" + "disabledDic"
//
//    }
//
//    private var normalDic: [String: Any] {
//        get {
//            if let obj = objc_getAssociatedObject(self, &AssocKeys.normalDic) as? [String: Any] {
//                return obj
//            }
//            let dic = [String: Any]()
//            objc_setAssociatedObject(self, &AssocKeys.normalDic, dic, .OBJC_ASSOCIATION_RETAIN_NONATOMIC);
//            return dic
//        }
//        set {
//            objc_setAssociatedObject(self, &AssocKeys.normalDic, newValue, .OBJC_ASSOCIATION_RETAIN_NONATOMIC);
//        }
//    }
//
//    private var heightDic: [String: Any] {
//        get {
//            if let obj = objc_getAssociatedObject(self, &AssocKeys.heightDic) as? [String: Any] {
//                return obj
//            }
//            let dic = [String: Any]()
//            objc_setAssociatedObject(self, &AssocKeys.heightDic, dic, .OBJC_ASSOCIATION_RETAIN_NONATOMIC);
//            return dic
//        }
//        set {
//            objc_setAssociatedObject(self, &AssocKeys.heightDic, newValue, .OBJC_ASSOCIATION_RETAIN_NONATOMIC);
//        }
//    }
//
//    private var selectedDic: [String: Any] {
//        get {
//            if let obj = objc_getAssociatedObject(self, &AssocKeys.selectedDic) as? [String: Any] {
//                return obj
//            }
//            let dic = [String: Any]()
//            objc_setAssociatedObject(self, &AssocKeys.selectedDic, dic, .OBJC_ASSOCIATION_RETAIN_NONATOMIC);
//            return dic
//        }
//        set {
//            objc_setAssociatedObject(self, &AssocKeys.selectedDic, newValue, .OBJC_ASSOCIATION_RETAIN_NONATOMIC);
//        }
//    }
//
//    private var disabledDic: [String: Any] {
//        get {
//            if let obj = objc_getAssociatedObject(self, &AssocKeys.disabledDic) as? [String: Any] {
//                return obj
//            }
//            let dic = [String: Any]()
//            objc_setAssociatedObject(self, &AssocKeys.disabledDic, dic, .OBJC_ASSOCIATION_RETAIN_NONATOMIC);
//            return dic
//        }
//        set {
//            objc_setAssociatedObject(self, &AssocKeys.disabledDic, newValue, .OBJC_ASSOCIATION_RETAIN_NONATOMIC);
//        }
//    }
//
//
...
//        switch state {
//        case .highlighted:
//            heightDic["layer.borderWidth"] = value
//
//        case .selected:
//            selectedDic["layer.borderWidth"] = value
//
//        case .disabled:
//            disabledDic["layer.borderWidth"] = value
//
//        default:
//            normalDic["layer.borderWidth"] = value
//        }
//    }
//
...
//        switch state {
//        case .highlighted:
//            heightDic["layer.borderColor"] = color
//
//        case .selected:
//            selectedDic["layer.borderColor"] = color
//
//        case .disabled:
//            disabledDic["layer.borderColor"] = color
//
//        default:
//            normalDic["layer.borderColor"] = color
//
//        }
//    }
//
...
//        switch state {
//        case .highlighted:
//            if let borderColor = heightDic["layer.borderColor"] as? UIColor {
//                color = borderColor
//            }
//
//        case .selected:
//            if let borderColor = selectedDic["layer.borderColor"] as? UIColor {
//                color = borderColor
//            }
//
//        case .disabled:
//            if let borderColor = disabledDic["layer.borderColor"] as? UIColor {
//                color = borderColor
//            }
//
//        default:
//            if let borderColor = normalDic["layer.borderColor"] as? UIColor {
//                color = borderColor
//            }
//        }
//        return color
