...
public extension UIView{
    ...
    @objc func animRotation(fromValue: Double, toValue: Double, duration: Double, repeatCount: Float, key: String?) {
        // 1.创建动画
    ...
    @objc func animRotation(isClockwise: Bool, duration: Double, repeatCount: Float, key: String?) {
