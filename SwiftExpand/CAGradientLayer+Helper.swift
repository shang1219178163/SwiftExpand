...
@objc public extension CAGradientLayer{
    ...
    static func gradientColorHexValue(_ from: Int, fromAlpha: CGFloat, to: Int, toAlpha: CGFloat = 1.0) -> [Any] {
        return [UIColor.hexValue(from, fromAlpha).cgColor, UIColor.hexValue(to, toAlpha).cgColor]
    }
    ...
    static var defaultColors: [Any] {
        get {
            ...
            if obj == nil {
                obj = [UIColor.hexValue(0x6cda53, 0.9).cgColor, UIColor.hexValue(0x1a965a, 0.9).cgColor]
