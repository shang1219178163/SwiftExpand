...
extension NSAttributedString{
    ...
    /// 富文本特殊部分设置
    @objc public static func attrDict(_ font: CGFloat, textColor: UIColor) -> Dictionary<NSAttributedString.Key, Any> {
    ...
    /// 富文本整体设置
    @objc public static func paraDict(_ font: CGFloat, textColor: UIColor, alignment: NSTextAlignment) -> Dictionary<NSAttributedString.Key, Any> {
    ...
    /// [源]富文本
    @objc public static func attString(_ text: String!, textTaps: [String]!, font: CGFloat = 16.0, tapFont: CGFloat = 16.0, color: UIColor = .black, tapColor: UIColor, alignment: NSTextAlignment = .left) -> NSAttributedString {
    ...
    /// 特定范围子字符串差异华显示
    @objc public static func attString(_ text: String!, offsetStart: Int, offsetEnd: Int) -> NSAttributedString! {
    ...
    /// 字符串差异华显示
    @objc public static func attString(_ text: String!, textSub: String) -> NSAttributedString! {
    ...
    /// nsRange范围子字符串差异华显示
    @objc public static func attString(_ text: String!, nsRange: NSRange) -> NSAttributedString! {
